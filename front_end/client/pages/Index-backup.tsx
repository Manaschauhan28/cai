...
import { ChevronLeft, ChevronRight, Mail, Phone, LogOut, User } from "lucide-react";
...
export default function Index() {
  ...
  const fetchTestimonials = async () => {
    try {
      ...
      const response = await fetch("https://expert-proud-corgi.ngrok-free.app/api/testimonials", {
        method: "GET",
        headers: {
      ...
      // Fallback to empty array or could use hardcoded data
      setTestimonials([]);
    } finally {
              ...
              >
                <div className="max-w-4xl mx-auto text-center">
                  ...
                  <blockquote className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed font-light italic">
                    "{testimonial.text || testimonial.content || testimonial.message || 'Great experience with CI GPT!'}"
                  </blockquote>
                  ...
                  <div className="flex items-center justify-center gap-6">
                    <div className="w-16 h-16 bg-gradient-to-r from-lime-400 to-purple-600 rounded-full flex items-center justify-center animate-pulse">
                      <span className="text-white font-bold text-lg">
                        {(testimonial.name || testimonial.author || 'User').charAt(0)}
                      </span>
                    </div>
                    <div className="text-left">
                      <h4 className="font-bold text-lg">{testimonial.name || testimonial.author || 'Anonymous User'}</h4>
                      ...
                      <p className="text-gray-500 text-xs">
                        {testimonial.date || testimonial.created_at || new Date().toLocaleDateString()}
                      </p>
                    </div>
                  </div>
                </div>
